...
struct TutorialView: View {
    ...
    private let pages = [
        ...
        TutorialPage(title: "AquesTalk Playerを使う", symbol: "waveform.badge.plus", message: "Mac版AquesTalk Playerを自分で導入すると、保存したプリセットから音声・字幕・口パクを作れます。", tips: ["公式アプリはVMSに同梱されません", "個人かつ非営利の場合のみ無償", "収益化・業務・法人や団体での利用には使用ライセンスが必要", "ライセンスキーはPlayer側だけで設定し、VMSには入力しません"]),
